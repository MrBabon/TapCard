...
SimpleForm.setup do |config|
  ...
  config.error_notification_class = 'fixed bottom-0 right-0 mx-4 mb-14 p-2 bg-red-100 rounded-full border-l-4 border-red-500 text-red-700 z-50 flash text-xs'
